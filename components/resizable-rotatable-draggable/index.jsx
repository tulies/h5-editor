...
//   }
// }
// import StyledRect from './Rect/StyledRect'
export default {
  data () {
    return { name: 'World' }
  },
  ...
  mounted(){
    console.log(this.$refs.sentence.getBoundingClientRect())
  },
  methods: {
    mous(){
      console.log(111)
  ...
  render (h) {
    return (
    <div ref="sentence" onMouseDown={this.mous}>
      <h1 class="red">{this.name}</h1>
    </div>
      )
  }
}
