    ...
    <div class="device-box">
      <div class="screen-box">
        <div class="element-items">
          <el-box v-for="el in pageData.cmps" :key="el._id" :el="el" :click-element="handleClickElement" />
          <!-- <el-box :el="el1" @click.stop.prevent="handleClickElement($event,el1)" /> -->
...
import ElBox from './el-box/index.vue'
export default {
  components: {
    RRZ,
    ElBox
